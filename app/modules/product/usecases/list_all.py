...
class ProductListAll:
    ...
    async def execute(self, category_id: int | None = None, page: int = 1, per_page: int = 10) -> list[ProductOutRead]:
        try:
        ...
        return [ProductOutRead.model_validate(product) for product in products]
